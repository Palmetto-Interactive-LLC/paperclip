---
name: ECC Agent: healthcare-reviewer
...
key: paperclipai/optional/ecc-agents/healthcare-reviewer
slug: healthcare-reviewer
...
tags:
  ...
  - reviewer
---
> **Provenance:** Adapted from ECC `agents/healthcare-reviewer.md` (subagent persona definition). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Agent Persona: healthcare-reviewer

**Suggested tools:** Read, Grep, Glob
