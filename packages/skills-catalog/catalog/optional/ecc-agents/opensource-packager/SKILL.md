---
name: ECC Agent: opensource-packager
...
key: paperclipai/optional/ecc-agents/opensource-packager
slug: opensource-packager
...
tags:
  ...
  - packager
---
> **Provenance:** Adapted from ECC `agents/opensource-packager.md` (subagent persona definition). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Agent Persona: opensource-packager

**Suggested tools:** Read, Write, Edit, Bash, Grep, Glob

**Suggested model tier:** haiku
