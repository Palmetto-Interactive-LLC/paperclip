---
name: ECC Agent: opensource-sanitizer
...
key: paperclipai/optional/ecc-agents/opensource-sanitizer
slug: opensource-sanitizer
...
tags:
  ...
  - sanitizer
---
> **Provenance:** Adapted from ECC `agents/opensource-sanitizer.md` (subagent persona definition). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Agent Persona: opensource-sanitizer
