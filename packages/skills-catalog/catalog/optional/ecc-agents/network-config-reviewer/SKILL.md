---
name: ECC Agent: network-config-reviewer
...
key: paperclipai/optional/ecc-agents/network-config-reviewer
slug: network-config-reviewer
...
tags:
  ...
  - reviewer
---
> **Provenance:** Adapted from ECC `agents/network-config-reviewer.md` (subagent persona definition). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Agent Persona: network-config-reviewer

**Suggested tools:** Read, Grep
