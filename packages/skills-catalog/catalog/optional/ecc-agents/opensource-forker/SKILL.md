---
name: ECC Agent: opensource-forker
...
key: paperclipai/optional/ecc-agents/opensource-forker
slug: opensource-forker
...
tags:
  ...
  - forker
---
> **Provenance:** Adapted from ECC `agents/opensource-forker.md` (subagent persona definition). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Agent Persona: opensource-forker
