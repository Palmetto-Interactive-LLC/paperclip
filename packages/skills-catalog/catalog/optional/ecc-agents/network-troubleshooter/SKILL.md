---
name: ECC Agent: network-troubleshooter
...
key: paperclipai/optional/ecc-agents/network-troubleshooter
...
tags:
  ...
  - troubleshooter
---
> **Provenance:** Adapted from ECC `agents/network-troubleshooter.md` (subagent persona definition). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Agent Persona: network-troubleshooter

**Suggested tools:** Read, Bash, Grep
