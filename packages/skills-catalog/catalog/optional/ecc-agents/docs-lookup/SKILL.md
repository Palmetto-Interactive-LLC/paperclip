...
key: paperclipai/optional/ecc-agents/docs-lookup
slug: docs-lookup
...
tags:
  ...
  - lookup
---
> **Provenance:** Adapted from ECC `agents/docs-lookup.md` (subagent persona definition). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Agent Persona: docs-lookup

**Suggested tools:** Read, Grep, mcp__context7__resolve-library-id, mcp__context7__query-docs
