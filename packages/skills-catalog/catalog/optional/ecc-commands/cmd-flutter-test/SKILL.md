...
key: paperclipai/optional/ecc-commands/cmd-flutter-test
slug: cmd-flutter-test
...
tags:
  ...
  - test
---
> **Provenance:** Adapted from ECC `commands/flutter-test.md` (slash-command recipe). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Command Recipe: flutter-test
