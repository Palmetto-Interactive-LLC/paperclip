---
name: ECC Command: prp-pr
description: Create a GitHub PR from current branch with unpushed commits — discovers templates, analyzes changes, pushes
key: paperclipai/optional/ecc-commands/cmd-prp-pr
slug: cmd-prp-pr
...
tags:
  ...
  - prp
---
> **Provenance:** Adapted from ECC `commands/prp-pr.md` (slash-command recipe). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Command Recipe: prp-pr
