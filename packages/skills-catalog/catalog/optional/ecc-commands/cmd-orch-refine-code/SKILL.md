---
name: ECC Command: orch-refine-code
...
key: paperclipai/optional/ecc-commands/cmd-orch-refine-code
slug: cmd-orch-refine-code
...
tags:
  ...
  - code
---
> **Provenance:** Adapted from ECC `commands/orch-refine-code.md` (slash-command recipe). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Command Recipe: orch-refine-code
