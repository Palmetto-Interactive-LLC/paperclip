---
name: ECC Command: security-scan
description: Run AgentShield against agent, hook, MCP, permission, and secret surfaces.
key: paperclipai/optional/ecc-commands/cmd-security-scan
slug: cmd-security-scan
...
tags:
  ...
  - scan
---
> **Provenance:** Adapted from ECC `commands/security-scan.md` (slash-command recipe). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Command Recipe: security-scan
