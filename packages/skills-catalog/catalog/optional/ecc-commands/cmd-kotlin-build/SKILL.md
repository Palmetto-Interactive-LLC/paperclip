...
key: paperclipai/optional/ecc-commands/cmd-kotlin-build
slug: cmd-kotlin-build
...
tags:
  ...
  - build
---
> **Provenance:** Adapted from ECC `commands/kotlin-build.md` (slash-command recipe). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Command Recipe: kotlin-build
