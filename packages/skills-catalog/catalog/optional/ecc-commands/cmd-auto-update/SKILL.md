---
name: ECC Command: auto-update
description: Pull the latest ECC repo changes and reinstall the current managed targets.
key: paperclipai/optional/ecc-commands/cmd-auto-update
slug: cmd-auto-update
...
tags:
  ...
  - update
---
> **Provenance:** Adapted from ECC `commands/auto-update.md` (slash-command recipe). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Command Recipe: auto-update
