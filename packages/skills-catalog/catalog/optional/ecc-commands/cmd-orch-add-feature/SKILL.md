---
name: ECC Command: orch-add-feature
...
key: paperclipai/optional/ecc-commands/cmd-orch-add-feature
slug: cmd-orch-add-feature
...
tags:
  ...
  - feature
---
> **Provenance:** Adapted from ECC `commands/orch-add-feature.md` (slash-command recipe). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Command Recipe: orch-add-feature
