---
name: ECC Command: plan
description: Restate requirements, assess risks, and create step-by-step implementation plan. WAIT for user CONFIRM before touching any code.
key: paperclipai/optional/ecc-commands/cmd-plan
slug: cmd-plan
...
tags:
  ...
  - plan
---
> **Provenance:** Adapted from ECC `commands/plan.md` (slash-command recipe). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Command Recipe: plan
