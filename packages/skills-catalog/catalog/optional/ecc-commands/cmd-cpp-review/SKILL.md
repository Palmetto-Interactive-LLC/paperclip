...
key: paperclipai/optional/ecc-commands/cmd-cpp-review
slug: cmd-cpp-review
...
tags:
  ...
  - review
---
> **Provenance:** Adapted from ECC `commands/cpp-review.md` (slash-command recipe). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Command Recipe: cpp-review
