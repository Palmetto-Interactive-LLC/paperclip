---
name: ECC Command: multi-execute
description: Execute a multi-model implementation plan while preserving Claude as the only filesystem writer.
key: paperclipai/optional/ecc-commands/cmd-multi-execute
slug: cmd-multi-execute
...
tags:
  ...
  - execute
---
> **Provenance:** Adapted from ECC `commands/multi-execute.md` (slash-command recipe). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Command Recipe: multi-execute
