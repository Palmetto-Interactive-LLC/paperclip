---
name: ECC Command: flutter-review
...
key: paperclipai/optional/ecc-commands/cmd-flutter-review
slug: cmd-flutter-review
...
tags:
  ...
  - review
---
> **Provenance:** Adapted from ECC `commands/flutter-review.md` (slash-command recipe). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Command Recipe: flutter-review
