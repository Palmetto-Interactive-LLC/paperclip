---
name: ECC Command: refactor-clean
description: Safely identify and remove dead code with verification after each change.
key: paperclipai/optional/ecc-commands/cmd-refactor-clean
slug: cmd-refactor-clean
...
tags:
  ...
  - clean
---
> **Provenance:** Adapted from ECC `commands/refactor-clean.md` (slash-command recipe). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Command Recipe: refactor-clean
