---
name: ECC Command: skill-create
description: Analyze local git history to extract coding patterns and generate SKILL.md files. Local version of the Skill Creator GitHub App.
key: paperclipai/optional/ecc-commands/cmd-skill-create
slug: cmd-skill-create
...
tags:
  ...
  - create
---
> **Provenance:** Adapted from ECC `commands/skill-create.md` (slash-command recipe). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Command Recipe: skill-create
