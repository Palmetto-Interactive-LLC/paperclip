---
name: ECC Command: sessions
description: Manage Claude Code session history, aliases, and session metadata.
key: paperclipai/optional/ecc-commands/cmd-sessions
slug: cmd-sessions
...
tags:
  ...
  - sessions
---
> **Provenance:** Adapted from ECC `commands/sessions.md` (slash-command recipe). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Command Recipe: sessions
