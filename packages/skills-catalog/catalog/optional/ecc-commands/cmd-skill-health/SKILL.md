---
name: ECC Command: skill-health
description: Show skill portfolio health dashboard with charts and analytics
key: paperclipai/optional/ecc-commands/cmd-skill-health
slug: cmd-skill-health
...
tags:
  ...
  - health
---
> **Provenance:** Adapted from ECC `commands/skill-health.md` (slash-command recipe). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Command Recipe: skill-health
