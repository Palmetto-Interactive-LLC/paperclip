---
name: ECC Command: gradle-build
description: Fix Gradle build errors for Android and KMP projects
key: paperclipai/optional/ecc-commands/cmd-gradle-build
slug: cmd-gradle-build
...
tags:
  ...
  - build
---
> **Provenance:** Adapted from ECC `commands/gradle-build.md` (slash-command recipe). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Command Recipe: gradle-build
