---
name: ECC Coding Rules: python
description: Coding standards, patterns, testing, and security guidance for python, imported from ECC's per-language rule set.
key: paperclipai/optional/ecc-rules/python
slug: python
...
tags:
  ...
  - python
---
> **Provenance:** Adapted from ECC `rules/python/` (6 rule files). Imported from ECC (ecc-universal) by Affaan Mustafa (https://github.com/affaan-m/ECC), mirrored at https://github.com/Palmetto-Interactive-LLC/ECC, MIT License. Copyright (c) 2026 Affaan Mustafa.

# ECC Coding Rules: python
